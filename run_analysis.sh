...
for i in "${!training_sets[@]}"; do
    ...
    run_command "python -u code/05_pretrained_transformer_methods.py $training_set" "Step 05$step_letter: Supervised language models ($training_set)" "log/05_pretrained_transformer_methods_$training_set.log"
done
